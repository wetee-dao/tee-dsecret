...
func NewGov(api model.ContractApi) *Gov {
	return &Gov{
		...
		transferEnabled:     &model.StoreValue[bool]{Namespace: "gov", Key: "transfer"},
		totalIssuance:       &model.StoreValue[model.Amount]{Namespace: "gov", Key: "issuance"},
		defaultTrack:        &model.StoreValue[uint32]{Namespace: "gov", Key: "default_track"},
		nextProposalIDStore: &model.StoreValue[uint32]{Namespace: "gov", Key: "next_proposal"},
		nextVoteIDStore:     &model.StoreValue[uint64]{Namespace: "gov", Key: "next_vote"},
		nextSpendIDStore:    &model.StoreValue[uint64]{Namespace: "gov", Key: "next_spend"},
		nextTrackIDStore:    &model.StoreValue[uint32]{Namespace: "gov", Key: "next_track"},
		...
		proposals:           &model.StoreMapping[uint32, Proposal]{Namespace: "gov", KeyPrefix: "proposal_"},
