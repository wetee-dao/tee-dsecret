...
func MakeAccountStorageKey(uint640 uint64) (types.StorageKey, error) {
	...
	return types.CreateStorageKey(&types1.Meta, "WeSudo", "Account", byteArgs...)
}
...
func MakeCloseDaoStorageKey(uint640 uint64) (types.StorageKey, error) {
	...
	byteArgs = append(byteArgs, encBytes)
	return types.CreateStorageKey(&types1.Meta, "WeSudo", "CloseDao", byteArgs...)
}
...
func MakeSudoTasksStorageKey(uint640 uint64) (types.StorageKey, error) {
	...
	byteArgs = append(byteArgs, encBytes)
	return types.CreateStorageKey(&types1.Meta, "WeSudo", "SudoTasks", byteArgs...)
}
