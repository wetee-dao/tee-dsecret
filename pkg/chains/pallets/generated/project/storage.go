...
func MakeNextProjectIdStorageKey() (types.StorageKey, error) {
	return types.CreateStorageKey(&types1.Meta, "Project", "NextProjectId")
}
...
func MakeDaoProjectsStorageKey(uint640 uint64) (types.StorageKey, error) {
	...
	return types.CreateStorageKey(&types1.Meta, "Project", "DaoProjects", byteArgs...)
}
...
func MakeTasksStorageKey(uint640 uint64) (types.StorageKey, error) {
	...
	byteArgs = append(byteArgs, encBytes)
	return types.CreateStorageKey(&types1.Meta, "Project", "Tasks", byteArgs...)
}
...
func MakeNextTaskIdStorageKey() (types.StorageKey, error) {
	return types.CreateStorageKey(&types1.Meta, "Project", "NextTaskId")
}
...
func MakeTaskReviewsStorageKey(uint640 uint64) (types.StorageKey, error) {
	...
	byteArgs = append(byteArgs, encBytes)
	return types.CreateStorageKey(&types1.Meta, "Project", "TaskReviews", byteArgs...)
}
